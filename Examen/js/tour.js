...
// INFOSPOT 2: plantas de interior
...
// INFOSPOT 7:Ventanas panoramicas
...
// INFOSPOT 8:  Planos y especificaciones
...
// INFOSPOT 9: galeria de imagenes
...
// INFOSPOT 10: Contacto del Agente Inmobiliario
...
infospot10.element.innerHTML = `
    <div class="infospot-content" style="background-color:rgba(128, 128, 128, 0.95); max-width: 350px;">
        ...
        <div style="text-align: center; margin: 15px 0;">
            ...
            <h3 style="margin: 10px 0 5px 0; color: white;">María Rodríguez</h3>
        ...
        <div style="background: rgba(255,255,255,0.1); padding: 10px; border-radius: 5px; margin: 10px 0;">
            ...
            <p style="margin: 5px 0;"><i class="fa-solid fa-envelope"></i> maria@luxuryrealestate.com</p>
